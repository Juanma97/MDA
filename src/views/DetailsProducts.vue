<template>
  ...
  >
    ...
    <v-carousel height="300">
      <v-carousel-item :src="this.item.image1" reverse-transition="fade" transition="fade"></v-carousel-item>
      <v-carousel-item :src="this.item.image2" reverse-transition="fade" transition="fade"></v-carousel-item>
      <v-carousel-item :src="this.item.image3" reverse-transition="fade" transition="fade"></v-carousel-item>
    </v-carousel>
    <div class="details">
      <h3>Name product</h3>
